...
class ColorPalette {
  ...
  setColors() {
    ...
    //document.getElementById('loading').style.background = "linear-gradient("+random(0, 360)+"deg, rgba("+random(30, 220)+","+random(30, 220)+","+random(30, 220)+",1) 0%, rgba("+random(30, 220)+","+random(30, 220)+","+random(30, 220)+",1) 48%, rgba("+random(30, 220)+","+random(30, 220)+","+random(30, 220)+",1) 100%)";
